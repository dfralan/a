import SwiftUI
import LifeHash /// Life Hash Library for hash visualization
        ...
        NavigationStack{
                        ...
                        if !inputKey.isEmpty {
                            withAnimation(.spring(response: 0.2, dampingFraction: 0.7, blendDuration: 0.2)) {
                                if keyManager.isValidBech32EncodedKey(inputKey){
                                    ...
                                    isInputKeyValid = false
                                    validationMessage = "The key must start with 'nsec' or 'npub' and be 63 characters long."
                                }
                            }
                        }
                    }
            ...
            .alert(isPresented: $showDeleteAllKeysAlert) {
                Alert(
                    ...
                    message: Text("Are you sure you want to delete all keys? If you do not have a backup with them you will lose access forever."),
                    ...
                    VStack(alignment: .leading){
                        ...
                        if privateKeyIsShowing {
                            ...
                            VStack(alignment: .leading, spacing: 10){
                                ...
                                Text("Sharing keys can compromise the security of the encrypted data. Please do not share this key with anyone.")
                                    .font(.subheadline)
                                    .foregroundColor(.red)
                                HStack{
                                    Button{
