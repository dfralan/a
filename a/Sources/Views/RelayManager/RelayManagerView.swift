                ...
                HStack{
                    ...
                    Button(action: {
                        ...
                        if newAddress.contains(",") {
                            urlStrings = newAddress.components(separatedBy: ",").map { $0.trimmingCharacters(in: .whitespaces) }
                        } else {
                        ...
                        urlStrings.forEach { urlString in
                            ...
                            if !trimmedUrlString.hasPrefix("wss://") {
                                ...
                                if let encodedUrlString = trimmedUrlString.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed),
                ...
                ScrollView{
                    VStack(spacing: 20){
                        ...
                        if storedRelays.relayItems.count > 1 && editing {
                            ...
                            Button{
                                UIPasteboard.general.string = (storedRelays.relayItems.map { $0.address }.sorted().joined(separator: ", "))
                            } label: {
                                Text("Copy All")
                                Spacer()
                                Image(systemName: "square.on.square")
...
struct RelayItemDetailView: View {
    let supportedNips = ["01", "02", "04", "09", "11", "12", "15", "16", "20", "22", "26", "28", "11", "12"]
