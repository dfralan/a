    ...
    var body: some View {
        NavigationStack{
            ScrollView{
                VStack(spacing: 25) {
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("Your private key is your password. If you lose this key, you will lose access to your account! Copy it and keep it in a safe place. There is no way to reset your private key.")
                    }
                }
            }
            Spacer()
            ...
            Button{
                ...
                HStack{
                    Spacer()
                    if !keysSaved {Text("I've already save my keys")
                    } else {
                        Text("Create")
                    }
