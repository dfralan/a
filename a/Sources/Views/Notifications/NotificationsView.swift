                        ...
                        NavigationLink(destination: SettingsView()) {
                            ...
                            case 1:
                                HStack(alignment: .center){
                                    ...
                                    Text("\(Text(notification.user).bold()) reacted with: \(Text(notification.context)) \(Text(notification.at).foregroundColor(.gray).font(.subheadline))")
                            ...
                            case 2:
                                HStack(alignment: .center){
                                    ...
                                    Text("\(Text(notification.user).bold()) commented: \(Text(notification.context)) \(Text(notification.at).foregroundColor(.gray).font(.subheadline))")
                                        .foregroundColor(.primary)
                                        .font(.body)
                            ...
                            case 3:
                                HStack(alignment: .center){
                                    ...
                                    Text("\(Text(notification.user).bold()) sent you: \(Text(notification.context))\(Text(Image(systemName: "bolt.fill")).foregroundColor(.yellow)) \(Text(notification.at).foregroundColor(.gray).font(.subheadline))")
                                        .foregroundColor(.primary)
                                        .font(.body)
                            ...
                            case 4:
                                HStack(alignment: .center) {
                                    HStack(alignment: .center){
                                        ...
                                        Text("\(Text(notification.user).bold()) started following you \(Text(notification.at).foregroundColor(.gray).font(.subheadline))")
                                            .foregroundColor(.primary)
                                            .font(.body)
