...
class NotificationManager: ObservableObject {
    ...
    init() {
        ...
        notifications.append(NotificationModel(user: "John", kind: 1, context: "😂", at: "10 minutes ago"))
        notifications.append(NotificationModel(user: "Sarah", kind: 2, context: "Hello handsome 😘", at: "1 hour ago"))
        notifications.append(NotificationModel(user: "Mike", kind: 3, context: "300", at: "2 days ago"))
        notifications.append(NotificationModel(user: "Emily", kind: 4, context: "Started following you", at: "1 week ago"))
    }
