...
class Coordinator: ObservableObject {
    ...
    @AppStorage("saturationColor") var saturationColor: Double = 0.99 /// Works on main app saturation, focus mode should work on independent mode
    ...
    init(){
        ...
        UIView.appearance(whenContainedInInstancesOf: [UIAlertController.self]).overrideUserInterfaceStyle = (themeModeSwitcherUI)
        
        /// Override UI Accent Color
        UIView.appearance(whenContainedInInstancesOf: [UIAlertController.self]).tintColor = UIColor(accentColorSwitcher)
    }
